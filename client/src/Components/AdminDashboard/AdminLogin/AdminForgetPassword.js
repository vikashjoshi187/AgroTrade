...
import { admingetOtp } from '../../../store/commonSlice';
// import { checkOtp, changePassword } from '../../../store/organizationSlice.js';
// import { checkOtp,changePassword } from '../../../store/adminSlice.js';
import { changePassword, checkOtp } from '../../../store/adminSlice.js';
        ...
        <Modal.Body>
          <div className="row m-0 w-100 p-0">
            <div className="col-12 col-lg-6  p-4" id="datacol" >
              <h2 className="midgreen text-center ">Forget Password</h2>
